...
#ifndef HAL_WIFIIOT_SDIO_H
#define HAL_WIFIIOT_SDIO_H

/**
 * @brief Indicates the number of extended registers on an SDIO device.
 */
#define HAL_WIFI_IOT_SDIO_EXTENDREG_COUNT  64
...
typedef struct {
    ...
    /** Common register */
    unsigned char                  commReg[HAL_WIFI_IOT_SDIO_EXTENDREG_COUNT];
