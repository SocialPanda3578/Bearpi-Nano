...
![创建TCP_Clien](/applications/BearPi/BearPi-HM_Nano/docs/figures/20_iot_tcp_server/创建TCP_Clien.png)
...
![TCP发送数据](/applications/BearPi/BearPi-HM_Nano/docs/figures/20_iot_tcp_server/TCP发送数据.png)