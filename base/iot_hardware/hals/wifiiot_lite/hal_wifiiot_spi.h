...
#ifndef HAL_WIFIIOT_SPI_H
#define HAL_WIFIIOT_SPI_H

/**
 * @brief Indicates the SPI callback, which is used in {@link SpiRegisterUsrFunc}.
 */
typedef void (*HalSpiIsrFunc)(void);
...
typedef enum {
    /** Channel 0 */
    HAL_WIFI_IOT_SPI_ID_0 = 0,
    /** Channel 1 */
    HAL_WIFI_IOT_SPI_ID_1,
} HalWifiIotSpiIdx;
...
typedef enum {
    /** Phase 0 */
    HAL_WIFI_IOT_SPI_CFG_CLOCK_CPHA_0,
    /** Phase 1 */
    HAL_WIFI_IOT_SPI_CFG_CLOCK_CPHA_1,
} HalWifiIotSpiCfgClockCpha;
...
typedef enum {
    /** Motorola protocol */
    HAL_WIFI_IOT_SPI_CFG_FRAM_MODE_MOTOROLA,
    /** Texas Instruments protocol */
    HAL_WIFI_IOT_SPI_CFG_FRAM_MODE_TI,
    /** Microwire protocol */
    HAL_WIFI_IOT_SPI_CFG_FRAM_MODE_MICROWIRE,
} HalWifiIotSpiCfgFramMode;
...
typedef enum {
    /** 4 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_4BIT = 0x3,
    /** 5 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_5BIT,
    /** 6 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_6BIT,
    /** 7 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_7BIT,
    /** 8 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_8BIT,
    /** 9 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_9BIT,
    /** 10 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_10BIT,
    /** 11 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_11BIT,
    /** 12 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_12BIT,
    /** 13 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_13BIT,
    /** 14 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_14BIT,
    /** 15 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_15BIT,
    /** 16 bits */
    HAL_WIFI_IOT_SPI_CFG_DATA_WIDTH_E_16BIT,
} HalWifiIotSpiCfgDataWidth;
...
typedef enum {
    /** Little-endian */
    HAL_WIFI_IOT_SPI_CFG_ENDIAN_LITTLE,
    /** Big-endian */
    HAL_WIFI_IOT_SPI_CFG_ENDIAN_BIG,
} HalWifiIotSpiCfgEndian;
